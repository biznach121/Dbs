...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783470068/stage4/spa_dbsbodytouch/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="DBS Body Touch - Certified skin and body therapy">
        <Image
          src={src}
          alt="DBS Body Touch - Certified skin and body therapy"
          fill
