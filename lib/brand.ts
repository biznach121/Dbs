...
export const brand: Brand = {
  name: "DBS Body Touch",
  shortName: "DBS",
  microTag: "CERTIFIED SKIN AND BODY THERAPY",
  description:
    "DBS Body Touch is a Accra massage studio built around one promise: you leave lighter than you came.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0555964993",
    phoneTel: "+233555964993",
    textPhone: "0555964993",
    textPhoneTel: "+233555964993",
    email: "hello@dbs.test",
    privacyEmail: "privacy@dbs.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@dbsbodytouch", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "the right touch\nchanges everything.\nCertified skin and body therapy.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      {
        body: "Accra moves fast — and somewhere between work, traffic and everyone else's needs, your own rest keeps falling to the bottom of the list. It shouldn't.",
        className: "left-[5%] top-[25%] max-w-[330px]",
      },
      {
        body: "DBS Body Touch exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
        className: "right-[4%] top-[50%] max-w-[360px]",
      },
      {
        body: "From the first touch you are taken care of. Aroma, warm light and steady hands pull you out of the noise and back into your body.",
    ...
    images: [
      {
        ...
        alt: "DBS Body Touch beauty treatment detail",
      ...
      },
      {
        ...
        alt: "DBS Body Touch self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "DBS Body Touch beauty ritual",
      ...
      },
      {
        ...
        alt: "DBS Body Touch calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "DBS Body Touch relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "DBS Body Touch beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "DBS Body Touch lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "DBS Body Touch mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "DBS Body Touch makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "DBS Body Touch foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@dbsbodytouch",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470070/stage4/spa_dbsbodytouch/tiktok_0.mp4",
        alt: "DBS Body Touch treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470071/stage4/spa_dbsbodytouch/tiktok_1.mp4",
        alt: "DBS Body Touch treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470073/stage4/spa_dbsbodytouch/tiktok_2.mp4",
        alt: "DBS Body Touch treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "DBS Body Touch self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "DBS Body Touch studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About DBS Body Touch",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "DBS Body Touch is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0555964993 and text 0555964993 for booking help.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0555964993, text 0555964993, or message @dbsbodytouch on Instagram." },
          ...
          { q: "Where are you located?", a: "DBS Body Touch is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "DBS Body Touch (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@dbs.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "DBS Body Touch is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@dbs.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to DBS Body Touch",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0555964993", href: "tel:+233555964993" },
      { label: "Text", value: "0555964993", href: "sms:+233555964993" },
      { label: "Instagram", value: "@dbsbodytouch", href: "https://www.tiktok.com/@dbsbodytouch" },
    ],
  },
  ...
  footer: {
    blurb:
      "DBS Body Touch in Accra — certified skin and body therapy.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@dbsbodytouch" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0555964993", href: "tel:+233555964993" },
          { label: "Text 0555964993", href: "sms:+233555964993" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "DBS Body Touch — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
